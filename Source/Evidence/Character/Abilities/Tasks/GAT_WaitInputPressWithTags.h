...
#include "GAT_WaitInputPressWithTags.generated.h"
 ...
 */
UCLASS()
class EVIDENCE_API UGAT_WaitInputPressWithTags : public UAbilityTask
{
	...
	*/
	...
	static UGAT_WaitInputPressWithTags* WaitInputPressWithTags(UGameplayAbility* OwningAbility, FGameplayTagContainer RequiredTags, FGameplayTagContainer IgnoredTags, bool bTestAlreadyPressed = false);
