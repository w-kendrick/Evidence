...
#include "GAT_WaitInteractableTarget.generated.h"
 ...
 */
UCLASS()
class EVIDENCE_API UGAT_WaitInteractableTarget : public UAbilityTask
{
	...
	*/
	...
	static UGAT_WaitInteractableTarget* WaitForInteractableTarget(UGameplayAbility* OwningAbility, FName TaskInstanceName, FCollisionProfileName TraceProfile, float MaxRange = 200.0f, float TimerPeriod = 0.1f, bool bShowDebug = true);
