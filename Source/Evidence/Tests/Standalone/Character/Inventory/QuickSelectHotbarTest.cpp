...
#include "QuickSelectHotbarTest.h"

void AQuickSelectHotbarTest::StartTest()
{
	Super::StartTest();
...
void AQuickSelectHotbarTest::Tick(float DeltaTime)
{
...
void AQuickSelectHotbarTest::TestNextSlot()
{
	CurrentSlotToTest -= 1;
