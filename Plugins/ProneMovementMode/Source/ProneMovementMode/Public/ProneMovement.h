...
UCLASS()
class PRONEMOVEMENTMODE_API UProneMovement : public UCharacterMovementComponent
{
	GENERATED_BODY()
...
class PRONEMOVEMENTMODE_API FSavedMove_Character_Prone : public FSavedMove_Character
{
...
class PRONEMOVEMENTMODE_API FNetworkPredictionData_Client_Character_Prone : public FNetworkPredictionData_Client_Character
{
